...
import ddf.minim.*;            //llamamos a la librería para la insersión de imágenes
...
void setup() {
  ...
  posX.add(5);  //aparicion inicial aleatoria en el eje x de la serpiente en el juego
  posY.add(5);  //aparicion inicial aleatoria en el eje y de la serpiente en el juego
